...
public class DefaultDependencyManagementServices implements DependencyManagementServices {
    ...
    private static class DependencyResolutionScopeServices {
        ...
        TransformerInvoker createTransformerInvoker(WorkExecutor<UpToDateResult> workExecutor,
                                                    FileSystemSnapshotter fileSystemSnapshotter, TransformerExecutionHistoryRepository historyRepository, ListenerManager listenerManager, ArtifactTransformListener artifactTransformListener, OutputFileCollectionFingerprinter outputFileCollectionFingerprinter, ProjectFinder projectFinder) {
